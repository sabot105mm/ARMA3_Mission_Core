...
MISSION_CORE_fnc_helpMenuTopics = {
    [
        ...
        ["Light Infrastructure (Power / Solar)",
            "Power Plants and Solar plants are <t color='#ffd24a'>light infrastructure</t>: small static garrisons.<br/><br/>They will <t color='#ff9a9a'>never</t>:<br/>- launch hunts or quadrant dispatches,<br/>- commit squads off their own marker.<br/><br/>But they DO fight back like a normal marker: once engaged, their neighbors dispatch counter-attacks and reinforcements while their own replenishment arrives from tree cover outside the marker.<br/><br/>Outposts are NOT infrastructure - they are full military positions and behave like any other contested marker."],
        ["Player Hunts",
            "REDFOR hunts you only when they genuinely <t color='#ff9a9a'>see you</t>: real line of sight plus awareness. Raw distance is never sight - no wallhacks.<br/><br/>Shared intel decays after ~60 seconds; hunt squads sweep your last known position and recorded heading.<br/><br/>Break line of sight and move off that heading - they chase stale intel.<br/><br/>If a hunt contingent finds you, its real sighting publishes fresh intel and every marked quadrant re-aims onto you instantly."],
        ["Quadrant Defense",
            "A contested garrison splits its squads into four <t color='#ffd24a'>quadrant</t> sectors (NE / SE / SW / NW) that sweep the whole marker to corner you.<br/><br/>Cross from one sector to another and the sweep re-aims to your new sector.<br/>A hunt squad's real re-sight re-aims every marked quadrant onto your position immediately."],
        ...
        ["Manpower Economy",
            "<t color='#ffd24a'>Ports</t> generate <t color='#ffd24a'>manpower</t>, accumulate it over time, and ship it to requesting bases, which deliver it to the markers that need men.<br/><br/>Recruiting any unit costs manpower; capturing a marker grants importance x 5 manpower.<br/><br/><t color='#ff9a9a'>Why it matters:</t> starving the enemy's ports starves their garrisons - replacements only flow where manpower already flows."],
        ["Aggression",
            "The enemy holds a single global <t color='#ffd24a'>aggression</t> meter (0-100).<br/><br/>It starts <t color='#7ee07e'>low</t> - the enemy holds off assaulting your markers until you provoke them.<br/><br/>You raise it by:<br/>- <t color='#ffd24a'>Capturing markers</t> - the bigger and more important the marker, the angrier they get.<br/>- <t color='#ffd24a'>Destroying supply convoys</t> - proportional to the supplies lost.<br/><br/>Enemy aggression also creeps up slowly over time. When it crosses the assault threshold the enemy launches full assaults - and <t color='#ff9a9a'>each assault spends aggression</t>, so after a big push they calm down and hold off again."],
